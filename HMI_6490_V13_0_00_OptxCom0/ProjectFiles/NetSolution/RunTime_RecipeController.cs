...
public class RunTime_RecipeController : BaseNetLogic
{
    ...
    public override void Start()
    {
        ...
        //Cavanna
        LoadFromPLCDone = LogicObject.GetVariable("LoadFromPLCDone");
        if (LoadFromPLCDone != null)
            variableSynchronizer.Add(LoadFromPLCDone);

        SaveToDBDone = LogicObject.GetVariable("SaveToDBDone");
        if (SaveToDBDone != null)
            variableSynchronizer.Add(SaveToDBDone);
        //Cavanna
    }
    ...
    //Cavanna
    private IUAVariable LoadFromPLCDone;
    private IUAVariable SaveToDBDone;
    //Cavanna
}
