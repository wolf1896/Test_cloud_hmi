...
Description:    This script is used to create the istances that compose the list of VIRTUAL AXES.
...
public class RuntimeNetLogic_CreateVirtualAxes : BaseNetLogic
{
    ...
    {
        Log.Warning("RuntimeNetLogic_CreateVirtualAxes", "Create start");
        ...
        if (IstanceNumber == 0) 
        {
            Log.Error("RuntimeNetLogic_CreateVirtualAxes", "Number of istance not set");
        }
        ...
        {        
            ...
            var WidgetInstance = InformationModel.Make<list_VirtualAxisDiagnostic>("VirtualAxes_" + i);
        ...
        Log.Warning("RuntimeNetLogic_CreateVirtualAxes", "Create ended");
